...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/js/task-3.js":[function(require,module,exports) {
// Promise Задание 3
var makeTransaction = function makeTransaction(transaction) {
  ...
  return new Promise(function (resolve, reject) {
    setTimeout(function () {
      var canProcess = Math.random() > 0.3; // генерує Успіх чи Провал
...
var logSuccess = function logSuccess(_ref) {
  var id = _ref.id,
      delay = _ref.delay;
  console.log("Transaction ".concat(id, " processed in ").concat(delay, "ms"));
}; // функція коли Провал
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/task-3.js"], null)
//# sourceMappingURL=/task-3.2460dbd4.js.map